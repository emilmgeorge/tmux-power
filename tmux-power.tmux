...
user=$(whoami)
LS="#[fg=$G04,bg=$TC,nobold] $user_icon $user@#h #[fg=$TC,bg=$G06,nobold]$rarrow#[fg=$TC,bg=$G06] $session_icon #S "
...
tmux_set window-status-current-format "#[fg=$BG,bg=$TC]$rarrow#[fg=$BG,bg=$TC,nobold] #I:#W#F #[fg=$TC,bg=$BG,nobold]$rarrow"
